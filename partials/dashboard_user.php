...
<div class="dashboard-section">
    ...
    <p class="section-text">
        Crée ton annonce pour te faire remarquer, ou modifie celle que tu as déjà publiée.
    </p>

    <?php require_once "form_player_post.php"; ?>

    <h3 class="section-subtitle">Tes annonces de joueur publiées</h3>

    <?php if (empty($playerPosts)) { ?>
        <p class="empty-state">Tu n'as pas encore publié d'annonce de joueur.</p>
    <?php } else { ?>
...
<div class="dashboard-section">
    <h2 class="section-title">Annonce d'équipe</h2>
    <p class="section-text">
        Cherche des joueurs pour compléter ton équipe.
    </p>

    <?php require_once "form_team_post.php"; ?>

    <h3 class="section-subtitle">Tes annonces d'équipe publiées</h3>

    <?php if (empty($teamPosts)) { ?>
        <p class="empty-state">Tu n'as pas encore publié d'annonce d'équipe.</p>
    <?php } else { ?>
        <div class="posts-grid">
